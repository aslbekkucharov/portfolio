...
export const workExpirience: IWorkExperience[] = [
    {
        ...
        company: 'Bulavka.uz | Middle Frontend Developer',
    ...
    },
    {
        ...
        company: 'Kirano.uz | Junior Frontend Developer',
        tech_stack: [
            'HTML',
            'SCSS',
            'JavaScript',
    ...
    },
    {
        ...
        company_link: '',
        company: 'Webtuning | Junior Frontend Developer',
        tech_stack: ['HTML', 'CSS', 'JavaScript', 'Bootstrap', 'jQuery'],
        responsibility:
            'Webtuning is a new web studio at that time. I learned a lot here, we worked with PHP code (layout of the template by design in Figma). I got acquainted with such concepts as FTP, Git, etc.',
    },
]
